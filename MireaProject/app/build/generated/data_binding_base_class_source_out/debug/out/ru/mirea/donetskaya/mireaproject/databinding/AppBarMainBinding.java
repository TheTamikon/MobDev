...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull CoordinatorLayout coordLayout, @NonNull FloatingActionButton fab,
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CoordinatorLayout coordLayout = (CoordinatorLayout) rootView;
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, coordLayout, fab, toolbar);
    }
